...
def part1(numbers, boards):
    for draw in numbers:
        for board in boards:
            ...
            #Check if win by row
            for i in range(ROW):
                if board[i*COL] == board[i*COL+1] == board[i*COL+2] == board[i*COL+3] == board[i*COL+4]:
                    winner = True
            #Check if win by col
            for i in range(COL):
                if board[i] == board[i+ROW] == board[i+ROW*2] == board[i+ROW*3] == board[i+ROW*4]:
                    winner = True
            #Check top left to bottom right diagonal
            if board[0] == board[COL+1] == board[COL*2+2] == board[COL*3+3] == board[COL*4+4]:
                winner = True
            if board[COL-1] == board[COL*2-2] == board[COL*3-3] == board[COL*4-4] == board[COL*5-5]:
                winner = True
            if winner:
                total = 0
                for number in board:
...
def part2(numbers, boards):
    ...
    for draw in numbers:
        for board in boards:
            ...
            if board[COL-1] == board[COL*2-2] == board[COL*3-3] == board[COL*4-4] == board[COL*5-5]:
                winner = True
            if winner and totalWinners == len(boards) - 2:
                total = 0
                for number in board:
                    if number != -1:
                        total += number
